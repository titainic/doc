...
export HADOOP_CONF_DIR=/home/titanic/soft/hadoop/hadoop-2.7.3/etc/hadoop
export SPARK_HOME=/home/titanic/soft/hadoop/spark-2.0.1-bin-hadoop2.7
export LIVY_LOG_DIR=/home/titanic/soft/hadoop/livy-server-0.2.0/logs
